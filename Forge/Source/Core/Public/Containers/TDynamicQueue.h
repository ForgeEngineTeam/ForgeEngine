...
namespace Forge {
	namespace Containers
	{
		...
		private:
			/**
			 * @brief Inserts a new element at the back of this collection. after
			...
			/**
			 * @brief This collection only allows insertion of elements at the back.
			 *
